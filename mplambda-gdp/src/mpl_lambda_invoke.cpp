...
void invokeLambda() {
    ...
    invokeRequest.SetFunctionName("mpl_gdp_lambda_aws_test");
    ...
    jsonPayload.WithString("coordinator", "73.252.162.190:25565");
    ...
    jsonPayload.WithString("env", "resources/se3/alpha_env-1.5.dae");
    jsonPayload.WithString("robot", "resources/se3/alpha_robot.dae");
